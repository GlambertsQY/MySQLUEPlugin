...
struct MYSQLUEPLUGIN_API FMySQLConnectorConnectionStruct
{
...
USTRUCT(BlueprintType)
struct MYSQLUEPLUGIN_API FMySQLConnectorKeyValuePair
{
	GENERATED_USTRUCT_BODY()
...
USTRUCT(BlueprintType)
struct MYSQLUEPLUGIN_API FMySQLConnectorQueryResultRow
{
	GENERATED_USTRUCT_BODY()
...
USTRUCT(BlueprintType)
struct MYSQLUEPLUGIN_API FMySQLConnectoreQueryResult
{
	GENERATED_USTRUCT_BODY()
...
*/
UCLASS()
class MYSQLUEPLUGIN_API UMySQLDatabase : public UObject
{
